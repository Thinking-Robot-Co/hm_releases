...
class VideoRecorder:
    ...
    def start_recording(self, with_audio=False):
        ...
        if self.with_audio and self.audio_recorder is not None:
            ...
            # self.camera.apply_video_transform(hflip=True, vflip=False, rotation=90, width=1920, height=1080, crop=(0, 0, 1, 1))
            self.camera.apply_video_transform(hflip=True, vflip=False, rotation=90, width=1280, height=720, zoom=0.8)
